...
public class ThingsBag extends InitialBag {
	...
	public void initializeThingsBag() {
		...
		people.add(new Person("Un escalier en colimaçon mal éclairé","src/main/resources/people/things/escaliers.jpg"));
		...
		people.add(new Person("Un vieux torchon mouillé oublié dans l'évier","src/main/resources/people/things/torchon.jpeg"));
		...
		people.add(new Person("😉","src/main/resources/people/things/emoji.jpg"));
